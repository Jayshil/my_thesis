...
for i in range(len(teff)):
	...
	obt = obs.query_region(coord,radius=0.01)
	b = np.array([])
	...
	for i11 in range(len(obsid1)):
		...
		os.system('rm -r mastDownload')
		f_data.write(name[i] + '_sector' + str(i11) + '\t' + str(teff[i]) + '\t' + str(lg[i]) + '\t' + str(mh[i]) + '\t' + str(vturb[i]) + '\t' + str(p[i]) + '\t' + str(pperr[i]) + '\t' + str(pnerr[i]) + '\t' + str(tc[i]) + '\t' + str(aste[i]) + '\t' + str(asteperr[i]) + '\t' + str(astenerr[i]) + '\t' + str(ecc[i]) + '\t' + str(ome[i]) + '\t' + str(rprst[i]) + '\t' + str(rprstperr[i]) + '\t' + str(rprstnerr[i]) + '\t' + str(tce[i]) + '\t' + ra[i] + '\t' + dec[i] + '\n')
		#--------------------------------------
		#-------Data Downloaded----------------
		...
		utl.move_file(in_path=path1,fi_name='/Fig.png',out_path=path1+'/Simulations/'+name[i]+ '_sector' + str(i11)+'/',new_name='Fig.png')
		...
		t0_m = np.median(t11)
		t0_s = np.std(t11)
		f1_to.write(name[i] + '_sector' + str(i11) + '\t' + str(t0_m) + '\t' + str(t0_s) + '\n')
		#--------------------------------------
		...
		utl.move_file(in_path = path1 + '/', fi_name = name[i] + '_sector' + str(i11) + '_lc.dat', out_path = path1 + '/Simulations/' + name[i] + '_sector' + str(i11) + '/data/', new_name = name[i] + '_sector' + str(i11) + '_lc.dat')
		np.savetxt(name[i] + '_sector' + str(i11) + '_lceparam.dat', time_bjd, newline = '\tTESS\n', delimiter = '\t')
		utl.move_file(in_path = path1 + '/', fi_name = name[i] + '_sector' + str(i11) + '_lceparam.dat', out_path = path1 + '/Simulations/' + name[i] + '_sector' + str(i11) +'/data/', new_name = name[i] + '_sector' + str(i11) + '_lceparam.dat')
		#--------------------------------------
		#------Creating Prior File-------------
		#--------------------------------------
		...
		f4_p.close()
		utl.move_file(path1 + '/', name[i] + '_sector' + str(i11) + '_priors_exm.dat', path1 + '/Simulations/' + name[i] + '_sector' + str(i11) + '/priors/', name[i] + '_sector' + str(i11) + '_priors_exm.dat')
		utl.move_file(path1 + '/', name[i] + '_sector' + str(i11) + '_priors_qp.dat', path1 + '/Simulations/' + name[i] + '_sector' + str(i11) +'/priors/', name[i] + '_sector' + str(i11) + '_priors_qp.dat')
		utl.move_file(path1 + '/', name[i] + '_sector' + str(i11) + '_priors_exm1.dat', path1 + '/Simulations/' + name[i] + '_sector' + str(i11) + '/priors/', name[i] + '_sector' + str(i11) + '_priors_exm1.dat')
		utl.move_file(path1 + '/', name[i] + '_sector' + str(i11) + '_priors_qp1.dat', path1 + '/Simulations/' + name[i] + '_sector' + str(i11) + '/priors/', name[i] + '_sector' + str(i11) + '_priors_qp1.dat')
		utl.new_dir(path1 + '/Simulations/' + name[i] + '_sector' + str(i11) + '/results/qp')
		utl.new_dir(path1 + '/Simulations/' + name[i] + '_sector' + str(i11) + '/results/exm')
		utl.new_dir(path1 + '/Simulations/' + name[i] + '_sector' + str(i11) +'/results/qp1')
		utl.new_dir(path1 + '/Simulations/' + name[i] + '_sector' + str(i11) + '/results/exm1')
		#--------------------------------------
		#-------Created Prior Files------------
		#--------------------------------------
		#--------------------------------------
		...
		#-------Limb Darkening Code------------
		#--------------------------------------
		fout = open(name[i] + '_sector' + str(i11) + '.dat','w')
		fout.write('#Name\tTeff\tLog(g)\t[M/H]\tVturb\tRF\t\t\tFT\tmin_w\tmax_w\n')
		fout.write(name[i] + '_sector' + str(i11) + '\t'+str(teff[i])+'\t'+str(lg[i])+'\t'+str(mh[i])+'\t'+str(vturb[i])+'\ttess_res_fun.txt\tA100,P100\t-1\t-1')
		fout.close()
		utl.move_file(path1 + '/', name[i]+ '_sector' + str(i11) + '.dat', path1 + '/limb-darkening-master/input_files/', name[i] + '_sector' + str(i11) + '.dat')
		#--------------------------------------
		#---------Running Juliet---------------
		#--------------------------------------
		#os.system('cd ~')
		...
		#os.system('cd ' + path1)
		os.system('python juliet.py -lcfile Simulations/' + name[i] + '_sector' + str(i11) + '/data/' + name[i] + '_sector' + str(i11) + '_lc.dat' + ' -lceparamfile Simulations/' + name[i] + '_sector' + str(i11) + '/data/' + name[i] + '_sector' + str(i11) + '_lceparam.dat -ldlaw TESS-quadratic -lctimedef TESS-TDB -priorfile Simulations/' + name[i] + '_sector' + str(i11) + '/priors/' + name[i] + '_sector' + str(i11) + '_priors_exm.dat -ofolder Simulations/' + name[i] + '_sector' + str(i11) + '/results/exm -nlive 500')#Ran simulation with Ex-M Kernel
		os.system('python juliet.py -lcfile Simulations/' + name[i] + '_sector' + str(i11) + '/data/' + name[i] + '_sector' + str(i11) + '_lc.dat' + ' -lceparamfile Simulations/' + name[i] + '_sector' + str(i11) + '/data/' + name[i] + '_sector' + str(i11) + '_lceparam.dat -ldlaw TESS-quadratic -lctimedef TESS-TDB -priorfile Simulations/' + name[i] + '_sector' + str(i11) + '/priors/' + name[i] + '_sector' + str(i11) + '_priors_qp.dat -ofolder Simulations/' + name[i] + '_sector' + str(i11) + '/results/qp -nlive 500')#Ran simulation with QP Kernel
		os.system('python juliet.py -lcfile Simulations/' + name[i] + '_sector' + str(i11) + '/data/' + name[i] + '_sector' + str(i11) + '_lc.dat' + ' -lceparamfile Simulations/' + name[i] + '_sector' + str(i11) + '/data/' + name[i] + '_sector' + str(i11) + '_lceparam.dat -ldlaw TESS-quadratic -lctimedef TESS-TDB -priorfile Simulations/' + name[i] + '_sector' + str(i11) + '/priors/' + name[i] + '_sector' + str(i11) + '_priors_exm1.dat -ofolder Simulations/' + name[i] + '_sector' + str(i11) + '/results/exm1 -nlive 500')#Ran simulation with Ex-M Kernel and making 'a' uniformally distributed
		os.system('python juliet.py -lcfile Simulations/' + name[i] + '_sector' + str(i11) + '/data/' + name[i] + '_sector' + str(i11) + '_lc.dat' + ' -lceparamfile Simulations/' + name[i] + '_sector' + str(i11) + '/data/' + name[i] + '_sector' + str(i11) + '_lceparam.dat -ldlaw TESS-quadratic -lctimedef TESS-TDB -priorfile Simulations/' + name[i] + '_sector' + str(i11) + '/priors/' + name[i] + '_sector' + str(i11) + '_priors_qp1.dat -ofolder Simulations/' + name[i] + '_sector' + str(i11) + '/results/qp1 -nlive 500')#Ran simulation with QP Kernel and making 'a' uniformally distributed
		#--------------------------------------
		#----Starting Limb-Darkening Code------
		#--------------------------------------
		os.system('python2.7 ' + path1 + '/limb-darkening-master/get_lds.py -ifile ' + path1 +'/limb-darkening-master/input_files/' + name[i] + '_sector' + str(i11) + '.dat -ofile ' + name[i] + '_sector' + str(i11) + '_LDC.dat')
		#--------------------------------------
		#---------------ATLAS------------------
		#--------------------------------------
		f5 = open(path1 + '/limb-darkening-master/results/' + name[i] + '_sector' + str(i11) + '_LDC.dat', 'r')
		con = f5.readlines()
		line = con[24]
		ind = np.array([])
		...
		f33.write(name[i] + '_sector' + str(i11) + '\t\t' + u1 + '\t\t' + u2 + '\t\t' + u3 + '\t\t' + u4 + '\n')
		#--------------------------------------
		#-------------PHOENIX------------------
		#--------------------------------------
		line1 = con[36]
		...
		f11.write(name[i] + '_sector' + str(i11) + '\t\t' + u1_p + '\t\t' + u2_p + '\t\t' + u3_p + '\t\t' + u4_p + '\n')
		#--------------------------------------
		...
		f1.write(name[i] + '_sector' + str(i11) + '\t' + str(c1_p) + '\t' + str(c2_p) + '\t' + str(c2_p) + '\t' + str(c2_p) + '\n')
		u1_p = ((12*c1_p)/35) + c2_p + ((164*c3_p)/105) + (2*c4_p)
		u2_p = ((10*c1_p)/31) - ((34*c3_p)/63) - c4_p
		f2.write(name[i] + '_sector' + str(i11) + '\t' + str(u1_p) + '\t' + str(u2_p) + '\n')
		#--------------------------------------
		...
		f3.write(name[i] + '_sector' + str(i11) + '\t' + str(c1_a) + '\t' + str(c2_a) + '\t' + str(c2_a) + '\t' + str(c2_a) + '\n')
		u1_a = ((12*c1_a)/35) + c2_a + ((164*c3_a)/105) + (2*c4_a)
		u2_a = ((10*c1_a)/31) - ((34*c3_a)/63) - c4_a
		f4.write(name[i] + '_sector' + str(i11) + '\t' + str(u1_a) + '\t' + str(u2_a) + '\n')
		#--------------------------------------
		#---Calculating which model is better--
		#--------------------------------------
		post_exm = pc.load(open(path1 + '/Simulations/' + name[i] + '_sector' + str(i11) + '/results/exm/posteriors.pkl','rb'))#, encoding='latin1')
		post_exm1 = pc.load(open(path1 + '/Simulations/' + name[i] + '_sector' + str(i11) + '/results/exm1/posteriors.pkl','rb'))#, encoding='latin1')
		post_qp = pc.load(open(path1 + '/Simulations/' + name[i] + '_sector' + str(i11) + '/results/qp1/posteriors.pkl','rb'))#, encoding='latin1')
		post_qp1 = pc.load(open(path1 + '/Simulations/' + name[i] + '_sector' + str(i11) + '/results/qp1/posteriors.pkl','rb'))#, encoding='latin1')
		lnze = post_exm['lnZ']
		lnze1 = post_exm1['lnZ']
		lnzqp = post_qp['lnZ']
		lnzqp1 = post_qp1['lnZ']
		...
		#--------------------------------------
		val,per,ner = np.loadtxt(path1 + '/Simulations/' + name[i] + '_sector' + str(i11) + '/results/' + model_a + '/posteriors.dat', usecols=(1,2,3), unpack=True)
		n1 = np.loadtxt(path1 + '/Simulations/' + name[i] + '_sector' + str(i11) + '/results/' + model_a + '/posteriors.dat', dtype=str, usecols=0, unpack=True)
		aj2 = np.where(n1=='a_p1')
		ae = val[aj2[0][0]]
		aeep = per[aj2[0][0]]
		aeen = ner[aj2[0][0]]
		f7.write(name[i] + '_sector' + str(i11) + '\t' + str(ae) + '\t' + str(aeep) + '\t' + str(aeen) + '\n')
		#--------------------------------------
		#----Storing Results of P and Rp/R*----
		#--------------------------------------
		val,per,ner = np.loadtxt(path1 + '/Simulations/' + name[i] + '_sector' + str(i11) + '/results/'+ model +'/posteriors.dat', usecols=(1,2,3), unpack=True)
		n1 = np.loadtxt(path1 + '/Simulations/' + name[i] + '_sector' + str(i11) + '/results/'+ model + '/posteriors.dat', dtype=str, usecols=0, unpack=True)
		...
		tce1p = per[tc1[0][0]]
		tce1n = ner[tc1[0][0]]
		f8.write(name[i] + '_sector' + str(i11) + '\t' + str(pe) + '\t' + str(peep) + '\t' + str(peen) + '\n')
		f9.write(name[i] + '_sector' + str(i11) + '\t' + str(re) + '\t' + str(reep) + '\t' + str(reen) + '\n')
		f10.write(name[i] + '_sector' + str(i11) + '\t' + str(tce1) + '\t' + str(tce1p) + '\t' + str(tce1n) + '\n')
		post_exm = pc.load(open(path1 + '/Simulations/' + name[i] + '_sector' + str(i11) + '/results/'+ model +'/posteriors.pkl','rb'))#, encoding = 'latin1')
		...
		f19.write(name[i] + '_sector' + str(i11) + '\t\t' + str(u1_exm) + '\t' + str(u1perr_exm) + '\t' + str(u1nerr_exm) + '\t')
		u2_exm = u22_exm[0]
...
fig_teff = plt.figure(figsize=(14,7))
...
fig_gr = plt.figure(figsize=(14,7))
...
fig_mh = plt.figure(figsize=(14,7))
...
plt.plot(teff2, line(teff2, *popt), 'r:')
plt.plot(teff2, line(teff2, *popt1), 'b:')
...
plt.plot(teff2, line(teff2, *popt2), 'r:')
plt.plot(teff2, line(teff2, *popt3), 'b:')
...
plt.plot(teff2, line(teff2, *popt4), 'r:')
plt.plot(teff2, line(teff2, *popt5), 'b:')
...
plt.plot(teff2, line(teff2, *popt6), 'r:')
plt.plot(teff2, line(teff2, *popt7), 'b:')
