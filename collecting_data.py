...
f1.write('#Name\tTeff\tlog(g)\t[M/H]\tVturb\tPeriod\tP+err\tP-err\tTc\ta/R*\ta+err\ta-err\tEccentricity\tOmega\tRp/R*\tr+err\tr-err\tTc-err\n')
...
while a:
	...
	f1.write(name + '\t' + teff + '\t' + lg + '\t' + mh + '\t' + vturb + '\t' + p + '\t' + pperr + '\t' + pnerr + '\t' + tc + '\t' + a + '\t' + aperr + '\t' + anerr + '\t' + ecc + '\t' + omega + '\t' + r + '\t' + rperr + '\t' + rnerr + '\t' + tcerr + '\n')
