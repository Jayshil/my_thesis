...
bis_u1_c_p_c = len(diff_u1_c_p)*np.log((rss_u1_c_p_c)/(len(diff_u1_c_p))) + np.log(len(diff_u1_c_p))
bis_u1_c_a_c = len(diff_u1_c_a)*np.log((rss_u1_c_a_c)/(len(diff_u1_c_a))) + np.log(len(diff_u1_c_a))
...
bis_u1_c_p_l = len(diff_u1_c_p)*np.log((rss_u1_c_p_l)/(len(diff_u1_c_p))) + 2*np.log(len(diff_u1_c_p))
bis_u1_c_a_l = len(diff_u1_c_a)*np.log((rss_u1_c_a_l)/(len(diff_u1_c_a))) + 2*np.log(len(diff_u1_c_a))
...
bis_u1_c_p_q = len(diff_u1_c_p)*np.log((rss_u1_c_p_q)/(len(diff_u1_c_p))) + 3*np.log(len(diff_u1_c_p))
bis_u1_c_a_q = len(diff_u1_c_a)*np.log((rss_u1_c_a_q)/(len(diff_u1_c_a))) + 3*np.log(len(diff_u1_c_a))
...
bis_u2_c_p_c = len(diff_u2_c_p)*np.log((rss_u2_c_p_c)/(len(diff_u2_c_p))) + np.log(len(diff_u2_c_p))
bis_u2_c_a_c = len(diff_u2_c_a)*np.log((rss_u2_c_a_c)/(len(diff_u2_c_a))) + np.log(len(diff_u2_c_a))
...
bis_u2_c_p_l = len(diff_u2_c_p)*np.log((rss_u2_c_p_l)/(len(diff_u2_c_p))) + 2*np.log(len(diff_u2_c_p))
bis_u2_c_a_l = len(diff_u2_c_a)*np.log((rss_u2_c_a_l)/(len(diff_u2_c_a))) + 2*np.log(len(diff_u2_c_a))
...
bis_u2_c_p_q = len(diff_u2_c_p)*np.log((rss_u2_c_p_q)/(len(diff_u2_c_p))) + 3*np.log(len(diff_u2_c_p))
bis_u2_c_a_q = len(diff_u2_c_a)*np.log((rss_u2_c_a_q)/(len(diff_u2_c_a))) + 3*np.log(len(diff_u2_c_a))
...
bis_u1_co_p_l = len(diff_u1_co_p)*np.log((rss_u1_co_p_l)/(len(diff_u1_co_p))) + 2*np.log(len(diff_u1_co_p))
bis_u1_co_a_l = len(diff_u1_co_a)*np.log((rss_u1_co_a_l)/(len(diff_u1_co_a))) + 2*np.log(len(diff_u1_co_a))
...
bis_u1_co_p_q = len(diff_u1_co_p)*np.log((rss_u1_co_p_q)/(len(diff_u1_co_p))) + 3*np.log(len(diff_u1_co_p))
bis_u1_co_a_q = len(diff_u1_co_a)*np.log((rss_u1_co_a_q)/(len(diff_u1_co_a))) + 3*np.log(len(diff_u1_co_a))
...
bis_u2_co_p_c = len(diff_u2_co_p)*np.log((rss_u2_co_p_c)/(len(diff_u2_co_p))) + np.log(len(diff_u2_co_p))
bis_u2_co_a_c = len(diff_u2_co_a)*np.log((rss_u2_co_a_c)/(len(diff_u2_co_a))) + np.log(len(diff_u2_co_a))
...
bis_u2_co_p_l = len(diff_u2_co_p)*np.log((rss_u2_co_p_l)/(len(diff_u2_co_p))) + 2*np.log(len(diff_u2_co_p))
bis_u2_co_a_l = len(diff_u2_co_a)*np.log((rss_u2_co_a_l)/(len(diff_u2_co_a))) + 2*np.log(len(diff_u2_co_a))
...
bis_u2_co_p_q = len(diff_u2_co_p)*np.log((rss_u2_co_p_q)/(len(diff_u2_co_p))) + 3*np.log(len(diff_u2_co_p))
bis_u2_co_a_q = len(diff_u2_co_a)*np.log((rss_u2_co_a_q)/(len(diff_u2_co_a))) + 3*np.log(len(diff_u2_co_a))
...
#--------------------------------------------------------------------------------------
#--------------------------------------------------------------------------------------
f102 = open(path1 + '/Results/bis.dat', 'w')
f102.write('\t\t\t\tu1\t\t\t\tu2\n')
f102.write('-------------------------------------------------------------------------------------------\n')
f102.write('                                                                                           \n')
f102.write('-------------------------------------------------------------------------------------------\n')
f102.write('Claret(2017), PHOENIX-s\t\t' + 'Constant fit  ' + str(bis_u1_c_p_c) + '\t' + str(bis_u2_c_p_c) + '\n')
f102.write('                       \t\t' + 'Linear fit    ' + str(bis_u1_c_p_l) + '\t' + str(bis_u2_c_p_l) + '\n')
f102.write('                       \t\t' + 'Quadratic fit ' + str(bis_u1_c_p_q) + '\t' + str(bis_u2_c_p_q) + '\n')
f102.write('-------------------------------------------------------------------------------------------\n')
f102.write('-------------------------------------------------------------------------------------------\n')
f102.write('Claret(2017), ATLAS    \t\t' + 'Constant fit  ' + str(bis_u1_c_a_c) + '\t' + str(bis_u2_c_a_c) + '\n')
f102.write('                       \t\t' + 'Linear fit    ' + str(bis_u1_c_a_l) + '\t' + str(bis_u2_c_a_l) + '\n')
f102.write('                       \t\t' + 'Quadratic fit ' + str(bis_u1_c_a_q) + '\t' + str(bis_u2_c_a_q) + '\n')
f102.write('-------------------------------------------------------------------------------------------\n')
f102.write('-------------------------------------------------------------------------------------------\n')
f102.write('EJ(2015), PHOENIX      \t\t' + 'Constant fit  ' + str(bis_u1_co_p_c) + '\t' + str(bis_u2_co_p_c) + '\n')
f102.write('                       \t\t' + 'Linear fit    ' + str(bis_u1_co_p_l) + '\t' + str(bis_u2_co_p_l) + '\n')
f102.write('                       \t\t' + 'Quadratic fit ' + str(bis_u1_co_p_q) + '\t' + str(bis_u2_co_p_q) + '\n')
f102.write('-------------------------------------------------------------------------------------------\n')
f102.write('-------------------------------------------------------------------------------------------\n')
f102.write('EJ(2015), ATLAS        \t\t' + 'Constant fit  ' + str(bis_u1_co_a_c) + '\t' + str(bis_u2_co_a_c) + '\n')
f102.write('                       \t\t' + 'Linear fit    ' + str(bis_u1_co_a_l) + '\t' + str(bis_u2_co_a_l) + '\n')
f102.write('                       \t\t' + 'Quadratic fit ' + str(bis_u1_co_a_q) + '\t' + str(bis_u2_co_a_q) + '\n')
f102.close()
