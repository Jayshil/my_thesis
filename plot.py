...
ax_u1_c_pr.errorbar(u1_j, u1_c_pr, xerr = [u1_jn, u1_jp], fmt='.', elinewidth=1, alpha=0.5, color='deepskyblue', zorder=5, label = 'PHOENIX LDCs - q method')
...
ax_u2_c_pr.errorbar(u2_j, u2_c_pr, xerr = [u2_jn, u2_jp], fmt='.', elinewidth=1, alpha=0.5, color='deepskyblue', zorder=5, label = 'PHOENIX LDCs - q method')
...
plt.errorbar(teff, diff_u1_c_p, yerr = [u1_jn, u1_jp], fmt='.', elinewidth=1, alpha=0.35, color='orangered', zorder=5, label = 'PHOENIX LDCs')
plt.errorbar(teff, diff_u1_c_a, yerr = [u1_jn, u1_jp], fmt='.', elinewidth=1, alpha=0.35, color='cornflowerblue',zorder=5, label = 'ATLAS LDCs')

#-----Plotting binned data
bin_teff, bin_teffe, bin_diff_u1_c_p, bin_diff_u1_c_pe = utl.binned_data(datax=teff, datay=diff_u1_c_p, datay_err=u1_jp)
plt.errorbar(bin_teff, bin_diff_u1_c_p, xerr=bin_teffe, yerr=bin_diff_u1_c_pe, fmt='o', color='orangered', mew=2, ms=8, alpha=1, markerfacecolor='white', mec='orangered', zorder=10)

bin_teff, bin_teffe, bin_diff_u1_c_a, bin_diff_u1_c_ae = utl.binned_data(datax=teff, datay=diff_u1_c_a, datay_err=u1_jp)
plt.errorbar(bin_teff, bin_diff_u1_c_a, xerr=bin_teffe, yerr=bin_diff_u1_c_ae, fmt='o', color='cornflowerblue', mew=2, alpha=1, ms=8, markerfacecolor='white', mec='cornflowerblue', zorder=10)
...
plt.errorbar(teff, diff_u2_c_p, yerr = [u2_jn, u2_jp], fmt='.', elinewidth=1, alpha=0.35, color='orangered', zorder=5, label = 'PHOENIX LDCs')
plt.errorbar(teff, diff_u2_c_a, yerr = [u2_jn, u2_jp], fmt='.', elinewidth=1, alpha=0.35, color='cornflowerblue',zorder=5, label = 'ATLAS LDCs')

#-----Plotting binned data
bin_teff, bin_teffe, bin_diff_u2_c_p, bin_diff_u2_c_pe = utl.binned_data(datax=teff, datay=diff_u2_c_p, datay_err=u2_jp)
plt.errorbar(bin_teff, bin_diff_u2_c_p, xerr=bin_teffe, yerr=bin_diff_u2_c_pe, fmt='o', color='orangered', mew=2, ms=8, alpha=1, markerfacecolor='white', mec='orangered', zorder=10)

bin_teff, bin_teffe, bin_diff_u2_c_a, bin_diff_u2_c_ae = utl.binned_data(datax=teff, datay=diff_u2_c_a, datay_err=u2_jp)
plt.errorbar(bin_teff, bin_diff_u2_c_a, xerr=bin_teffe, yerr=bin_diff_u2_c_ae, fmt='o', color='cornflowerblue', mew=2, alpha=1, ms=8, markerfacecolor='white', mec='cornflowerblue', zorder=10)
...
if 'constant' in best_bic_u2_c_p:
	plt.plot(t11, constant(t11, *popt2_c), color='orangered', ls='-.', zorder=3, alpha=0.85)
elif 'linear' in best_bic_u2_c_p:
	plt.plot(t11, line(t11, *popt2_l), color='orangered',ls='-.', zorder=3, alpha=0.85)
elif 'quadratic' in best_bic_u2_c_p:
	plt.plot(t11, quadratic(t11, *popt2_q), color='orangered', ls='-.', zorder=3, alpha=0.85)

best_bic_u2_c_a = utl.lowest_bic(dict_bic_u2_c_a)
if 'constant' in best_bic_u2_c_a:
	plt.plot(t11, constant(t11, *popt3_c), color='cornflowerblue', ls='-.', zorder=3, alpha=0.85)
elif 'linear' in best_bic_u2_c_a:
	plt.plot(t11, line(t11, *popt3_l), color='cornflowerblue',ls='-.', zorder=3, alpha=0.85)
...
plt.errorbar(teff, diff_u1_co_p, yerr = [u1_jn, u1_jp], fmt='.', elinewidth=1, alpha=0.35, color='orangered', zorder=5, label = 'PHOENIX LDCs')
plt.errorbar(teff, diff_u1_co_a, yerr = [u1_jn, u1_jp], fmt='.', elinewidth=1, alpha=0.35, color='cornflowerblue',zorder=5, label = 'ATLAS LDCs')

#-----Plotting binned data
bin_teff, bin_teffe, bin_diff_u1_co_p, bin_diff_u1_co_pe = utl.binned_data(datax=teff, datay=diff_u1_co_p, datay_err=u1_jp)
plt.errorbar(bin_teff, bin_diff_u1_co_p, xerr=bin_teffe, yerr=bin_diff_u1_co_pe, fmt='o', color='orangered', mew=2, ms=8, alpha=1, markerfacecolor='white', mec='orangered', zorder=10)

bin_teff, bin_teffe, bin_diff_u1_co_a, bin_diff_u1_co_ae = utl.binned_data(datax=teff, datay=diff_u1_co_a, datay_err=u1_jp)
plt.errorbar(bin_teff, bin_diff_u1_co_a, xerr=bin_teffe, yerr=bin_diff_u1_co_ae, fmt='o', color='cornflowerblue', mew=2, alpha=1, ms=8, markerfacecolor='white', mec='cornflowerblue', zorder=10)
...
if 'constant' in best_bic_u1_co_p:
	plt.plot(t11, constant(t11, *popt4_c), color='orangered', ls='-.', zorder=3, alpha=0.85)
if 'linear' in best_bic_u1_co_p:
	plt.plot(t11, line(t11, *popt4_l), color='orangered',ls='-.', zorder=3, alpha=0.85)
if 'quadratic' in best_bic_u1_co_p:
	plt.plot(t11, quadratic(t11, *popt4_q), color='orangered', ls='-.', zorder=3, alpha=0.85)

best_bic_u1_co_a = utl.lowest_bic(dict_bic_u1_co_a)
if 'constant' in best_bic_u1_co_a:
	plt.plot(t11, constant(t11, *popt5_c), color='cornflowerblue', ls='-.', zorder=3, alpha=0.85)
if 'linear' in best_bic_u1_co_a:
	plt.plot(t11, line(t11, *popt5_l), color='cornflowerblue',ls='-.', zorder=3, alpha=0.85)
...
plt.errorbar(teff, diff_u2_co_p, yerr = [u2_jn, u2_jp], fmt='.', elinewidth=1, alpha=0.35, color='orangered', zorder=5, label = 'PHOENIX LDCs')
plt.errorbar(teff, diff_u2_co_a, yerr = [u2_jn, u2_jp], fmt='.', elinewidth=1, alpha=0.35, color='cornflowerblue',zorder=5, label = 'ATLAS LDCs')

#----Plotting binned data
bin_teff, bin_teffe, bin_diff_u2_co_p, bin_diff_u2_co_pe = utl.binned_data(datax=teff, datay=diff_u2_co_p, datay_err=u2_jp)
plt.errorbar(bin_teff, bin_diff_u2_co_p, xerr=bin_teffe, yerr=bin_diff_u2_co_pe, fmt='o', color='orangered', mew=2, ms=8, alpha=1, markerfacecolor='white', mec='orangered', zorder=10)

bin_teff, bin_teffe, bin_diff_u2_co_a, bin_diff_u2_co_ae = utl.binned_data(datax=teff, datay=diff_u2_co_a, datay_err=u2_jp)
plt.errorbar(bin_teff, bin_diff_u2_co_a, xerr=bin_teffe, yerr=bin_diff_u2_co_ae, fmt='o', color='cornflowerblue', mew=2, alpha=1, ms=8, markerfacecolor='white', mec='cornflowerblue', zorder=10)
...
if 'constant' in best_bic_u2_co_p:
	plt.plot(t11, constant(t11, *popt6_c), color='orangered', ls='-.', zorder=3, alpha=0.85)
elif 'linear' in best_bic_u2_co_p:
	plt.plot(t11, line(t11, *popt6_l), color='orangered', ls='-.', zorder=3, alpha=0.85)
elif 'quadratic' in best_bic_u2_co_p:
	plt.plot(t11, quadratic(t11, *popt6_q), color='orangered', ls='-.', zorder=3, alpha=0.85)

best_bic_u2_co_a = utl.lowest_bic(dict_bic_u2_co_a)
if 'constant' in best_bic_u2_co_a:
	plt.plot(t11, constant(t11, *popt7_c), color='cornflowerblue', ls='-.', zorder=3, alpha=0.85)
elif 'linear' in best_bic_u2_co_a:
	plt.plot(t11, line(t11, *popt7_l), color='cornflowerblue', ls='-.', zorder=3, alpha=0.85)
...
#------------------------------------------------
print('---------u1 - Claret(2017) - r ---------------------')
#------------------------------------------------

fig1r = plt.figure(figsize=(8,6))

plt.errorbar(teff, diff_u1_c_p, yerr = [u1_jn, u1_jp], fmt='.', elinewidth=1, alpha=0.35, color='deepskyblue', zorder=5, label = 'PHOENIX LDCs - q method')
plt.errorbar(teff, diff_u1_c_ar, yerr = [u1_jn, u1_jp], fmt='.', elinewidth=1, alpha=0.35, color='darkred',zorder=5, label = 'PHOENIX LDCs - r method')

#-----Plotting binned data
bin_teff, bin_teffe, bin_diff_u1_c_p, bin_diff_u1_c_pe = utl.binned_data(datax=teff, datay=diff_u1_c_p, datay_err=u1_jp)
plt.errorbar(bin_teff, bin_diff_u1_c_p, xerr=bin_teffe, yerr=bin_diff_u1_c_pe, fmt='o', color='deepskyblue', mew=2, ms=8, alpha=1, markerfacecolor='white', mec='deepskyblue', zorder=10)

bin_teff, bin_teffe, bin_diff_u1_c_ar, bin_diff_u1_c_aer = utl.binned_data(datax=teff, datay=diff_u1_c_ar, datay_err=u1_jp)
plt.errorbar(bin_teff, bin_diff_u1_c_ar, xerr=bin_teffe, yerr=bin_diff_u1_c_aer, fmt='o', color='darkred', mew=2, alpha=1, ms=8, markerfacecolor='white', mec='darkred', zorder=10)
...
f222 = open(path1 + '/Results/variation_with_temp/Off/off_u1_cla_p_r.dat', 'w')
for i in range(len(teff)):
	ddd = 5*(u1_jp[i]) - np.abs(diff_u1_c_ar[i])
	if ddd<0:
		f222.write(name[i] + '\t' + str(u1_j[i]) + '+-' + str(u1_jp[i]) + '\t' + str(np.abs(diff_u1_c_ar[i])) + '\n')
...
#----Constant fitting
popt_cr, pcov_cr = cft(constant, teff, diff_u1_c_p)
popt1_cr, pcov1_cr = cft(constant, teff, diff_u1_c_ar)

rss_u1_c_p_c = rss_u1_c_ar_c = 0
for i in range(len(teff)):
	r111 = (diff_u1_c_p[i] - constant(teff[i], *popt_cr))**2
	rss_u1_c_p_c = rss_u1_c_p_c + r111
	r222 = (diff_u1_c_ar[i] - constant(teff[i], *popt1_cr))**2
	rss_u1_c_ar_c = rss_u1_c_ar_c + r222

bic_u1_c_p_cr = len(diff_u1_c_p)*np.log((rss_u1_c_p_c)/(len(diff_u1_c_p))) + np.log(len(diff_u1_c_p))
bic_u1_c_a_cr = len(diff_u1_c_ar)*np.log((rss_u1_c_ar_c)/(len(diff_u1_c_a))) + np.log(len(diff_u1_c_a))

#----Linear fitting
popt_lr, pcov_lr = cft(line, teff, diff_u1_c_p)
popt1_lr, pcov1_lr = cft(line, teff, diff_u1_c_ar)

rss_u1_c_p_lr = rss_u1_c_a_lr = 0
for i in range(len(teff)):
	r111 = (diff_u1_c_p[i] - line(teff[i], *popt_lr))**2
	rss_u1_c_p_lr = rss_u1_c_p_lr + r111
	r222 = (diff_u1_c_ar[i] - line(teff[i], *popt1_lr))**2
	rss_u1_c_a_lr = rss_u1_c_a_lr + r222

bic_u1_c_p_lr = len(diff_u1_c_p)*np.log((rss_u1_c_p_lr)/(len(diff_u1_c_p))) + 2*np.log(len(diff_u1_c_p))
bic_u1_c_a_lr = len(diff_u1_c_ar)*np.log((rss_u1_c_a_lr)/(len(diff_u1_c_ar))) + 2*np.log(len(diff_u1_c_ar))

#----Quadratic fitting
popt_qr, pcov_qr = cft(quadratic, teff, diff_u1_c_p)
popt1_qr, pcov1_qr = cft(quadratic, teff, diff_u1_c_ar)

rss_u1_c_p_qr = rss_u1_c_a_qr = 0
for i in range(len(teff)):
	r111 = (diff_u1_c_p[i] - quadratic(teff[i], *popt_qr))**2
	rss_u1_c_p_qr = rss_u1_c_p_qr + r111
	r222 = (diff_u1_c_ar[i] - quadratic(teff[i], *popt1_qr))**2
	rss_u1_c_a_qr = rss_u1_c_a_qr + r222

bic_u1_c_p_qr = len(diff_u1_c_p)*np.log((rss_u1_c_p_qr)/(len(diff_u1_c_p))) + 3*np.log(len(diff_u1_c_p))
bic_u1_c_a_qr = len(diff_u1_c_ar)*np.log((rss_u1_c_a_qr)/(len(diff_u1_c_ar))) + 3*np.log(len(diff_u1_c_ar))

#----Plotting models
bic_u1_c_pr = [bic_u1_c_p_cr, bic_u1_c_p_lr, bic_u1_c_p_qr]
bic_u1_c_ar = [bic_u1_c_a_cr, bic_u1_c_a_lr, bic_u1_c_a_qr]

dict_bic_u1_c_pr = {}
dict_bic_u1_c_ar = {}
for i in range(3):
	dict_bic_u1_c_pr[model[i]] = bic_u1_c_pr[i]
	dict_bic_u1_c_ar[model[i]] = bic_u1_c_ar[i]

best_bic_u1_c_pr = utl.lowest_bic(dict_bic_u1_c_pr)
if 'constant' in best_bic_u1_c_pr:
	plt.plot(t11, constant(t11, *popt_cr), color = 'deepskyblue', ls = '-.', zorder=3, alpha=0.85)
elif 'linear' in best_bic_u1_c_pr:
	plt.plot(t11, line(t11, *popt_lr), color='deepskyblue', ls='-.', zorder=3, alpha=0.85)
elif 'quadratic' in best_bic_u1_c_pr:
	plt.plot(t11, quadratic(t11, *popt_qr), color = 'deepskyblue', ls='-.', zorder=3, alpha=0.85)

best_bic_u1_c_ar = utl.lowest_bic(dict_bic_u1_c_ar)
if 'constant' in best_bic_u1_c_ar:
	plt.plot(t11, constant(t11, *popt1_cr), color = 'darkred', ls = '-.', zorder=3, alpha=0.85)
elif 'linear' in best_bic_u1_c_ar:
	plt.plot(t11, line(t11, *popt1_lr), color='darkred', ls='-.', zorder=3, alpha=0.85)
...
#------------------------------------------------
print('---------u2 - Claret(2017) - r ---------------------')
#------------------------------------------------

fig2r = plt.figure(figsize=(8,6))

plt.errorbar(teff, diff_u2_c_p, yerr = [u2_jn, u2_jp], fmt='.', elinewidth=1, alpha=0.35, color='deepskyblue', zorder=5, label = 'PHOENIX LDCs - q method')
plt.errorbar(teff, diff_u2_c_ar, yerr = [u2_jn, u2_jp], fmt='.', elinewidth=1, alpha=0.35, color='darkred',zorder=5, label = 'PHOENIX LDCs - r method')

#-----Plotting binned data
bin_teff, bin_teffe, bin_diff_u2_c_p, bin_diff_u2_c_pe = utl.binned_data(datax=teff, datay=diff_u2_c_p, datay_err=u2_jp)
plt.errorbar(bin_teff, bin_diff_u2_c_p, xerr=bin_teffe, yerr=bin_diff_u2_c_pe, fmt='o', color='deepskyblue', mew=2, ms=8, alpha=1, markerfacecolor='white', mec='deepskyblue', zorder=10)

bin_teff, bin_teffe, bin_diff_u2_c_ar, bin_diff_u2_c_aer = utl.binned_data(datax=teff, datay=diff_u2_c_ar, datay_err=u2_jp)
plt.errorbar(bin_teff, bin_diff_u2_c_ar, xerr=bin_teffe, yerr=bin_diff_u2_c_aer, fmt='o', color='darkred', mew=2, alpha=1, ms=8, markerfacecolor='white', mec='darkred', zorder=10)

#plt.plot(teff, med2, 'red', teff, med4, 'blue')
#plt.fill_between(teff, med2 + std2, med2 - std2, color = 'red', alpha = 0.5)
#plt.fill_between(teff, med4 + std4, med4 - std4, color = 'blue', alpha = 0.5)

f444 = open(path1 + '/Results/variation_with_temp/Off/off_u2_cla_a_r.dat', 'w')
for i in range(len(teff)):
	ddd = 5*(u2_jp[i]) - np.abs(diff_u2_c_ar[i])
	if ddd<0:
		f444.write(name[i] + '\t' + str(u2_j[i]) + '+-' + str(u2_jp[i]) + '\t' + str(np.abs(diff_u2_c_ar[i])) + '\n')

f444.close()

#----Constant fitting
popt2_cr, pcov2_cr = cft(constant, teff, diff_u2_c_p)
popt3_cr, pcov3_cr = cft(constant, teff, diff_u2_c_ar)

rss_u2_c_p_cr = rss_u2_c_a_cr = 0
for i in range(len(teff)):
	r111 = (diff_u2_c_p[i] - constant(teff[i], *popt2_cr))**2
	rss_u2_c_p_cr = rss_u2_c_p_cr + r111
	r222 = (diff_u2_c_ar[i] - constant(teff[i], *popt3_cr))**2
	rss_u2_c_a_cr = rss_u2_c_a_cr + r222

bic_u2_c_p_cr = len(diff_u2_c_p)*np.log((rss_u2_c_p_cr)/(len(diff_u2_c_p))) + np.log(len(diff_u2_c_p))
bic_u2_c_a_cr = len(diff_u2_c_ar)*np.log((rss_u2_c_a_cr)/(len(diff_u2_c_ar))) + np.log(len(diff_u2_c_ar))

#----Linear fitting
popt2_lr, pcov2_lr = cft(line, teff, diff_u2_c_p)
popt3_lr, pcov3_lr = cft(line, teff, diff_u2_c_ar)

rss_u2_c_p_lr = rss_u2_c_a_lr = 0
for i in range(len(teff)):
	r111 = (diff_u2_c_p[i] - line(teff[i], *popt2_lr))**2
	rss_u2_c_p_lr = rss_u2_c_p_lr + r111
	r222 = (diff_u2_c_ar[i] - line(teff[i], *popt3_lr))**2
	rss_u2_c_a_lr = rss_u2_c_a_lr + r222

bic_u2_c_p_lr = len(diff_u2_c_p)*np.log((rss_u2_c_p_lr)/(len(diff_u2_c_p))) + 2*np.log(len(diff_u2_c_p))
bic_u2_c_a_lr = len(diff_u2_c_ar)*np.log((rss_u2_c_a_lr)/(len(diff_u2_c_ar))) + 2*np.log(len(diff_u2_c_ar))

#----Quadratic fitting
popt2_qr, pcov2_qr = cft(quadratic, teff, diff_u2_c_p)
popt3_qr, pcov3_qr = cft(quadratic, teff, diff_u2_c_ar)

rss_u2_c_p_qr = rss_u2_c_a_qr = 0
for i in range(len(teff)):
	r111 = (diff_u2_c_p[i] - quadratic(teff[i], *popt2_qr))**2
	rss_u2_c_p_qr = rss_u2_c_p_qr + r111
	r222 = (diff_u2_c_ar[i] - quadratic(teff[i], *popt3_qr))**2
	rss_u2_c_a_qr = rss_u2_c_a_qr + r222

bic_u2_c_p_qr = len(diff_u2_c_p)*np.log((rss_u2_c_p_qr)/(len(diff_u2_c_p))) + 3*np.log(len(diff_u2_c_p))
bic_u2_c_a_qr = len(diff_u2_c_ar)*np.log((rss_u2_c_a_qr)/(len(diff_u2_c_ar))) + 3*np.log(len(diff_u2_c_ar))

#----Plotting models
bic_u2_c_pr = [bic_u2_c_p_cr, bic_u2_c_p_lr, bic_u2_c_p_qr]
bic_u2_c_ar = [bic_u2_c_a_cr, bic_u2_c_a_lr, bic_u2_c_a_qr]

dict_bic_u2_c_pr = {}
dict_bic_u2_c_ar = {}
for i in range(3):
	dict_bic_u2_c_pr[model[i]] = bic_u2_c_pr[i]
	dict_bic_u2_c_ar[model[i]] = bic_u2_c_ar[i]

best_bic_u2_c_pr = utl.lowest_bic(dict_bic_u2_c_pr)
if 'constant' in best_bic_u2_c_pr:
	plt.plot(t11, constant(t11, *popt2_cr), color='deepskyblue', ls='-.', zorder=3, alpha=0.85)
elif 'linear' in best_bic_u2_c_pr:
	plt.plot(t11, line(t11, *popt2_lr), color='deepskyblue',ls='-.', zorder=3, alpha=0.85)
elif 'quadratic' in best_bic_u2_c_pr:
	plt.plot(t11, quadratic(t11, *popt2_qr), color='deepskyblue', ls='-.', zorder=3, alpha=0.85)

best_bic_u2_c_ar = utl.lowest_bic(dict_bic_u2_c_ar)
if 'constant' in best_bic_u2_c_ar:
	plt.plot(t11, constant(t11, *popt3_cr), color='darkred', ls='-.', zorder=3, alpha=0.85)
elif 'linear' in best_bic_u2_c_ar:
	plt.plot(t11, line(t11, *popt3_lr), color='darkred',ls='-.', zorder=3, alpha=0.85)
...
f102.write('                                                                                           \n')
f102.write('-------------------------------------------------------------------------------------------\n')
f102.write('Claret(2017), PHOENIX-q\t\t' + 'Constant fit  \t' + str(bic_u1_c_p_c) + '\t' + str(bic_u2_c_p_c) + '\n')
f102.write('                       \t\t' + 'Linear fit    \t' + str(bic_u1_c_p_l) + '\t' + str(bic_u2_c_p_l) + '\n')
f102.write('                       \t\t' + 'Quadratic fit \t' + str(bic_u1_c_p_q) + '\t' + str(bic_u2_c_p_q) + '\n')
f102.write('-------------------------------------------------------------------------------------------\n')
f102.write('-------------------------------------------------------------------------------------------\n')
f102.write('Claret(2017), PHOENIX-r\t\t' + 'Constant fit  \t' + str(bic_u1_c_a_cr) + '\t' + str(bic_u2_c_a_cr) + '\n')
f102.write('                       \t\t' + 'Linear fit    \t' + str(bic_u1_c_a_lr) + '\t' + str(bic_u2_c_a_lr) + '\n')
f102.write('                       \t\t' + 'Quadratic fit \t' + str(bic_u1_c_a_qr) + '\t' + str(bic_u2_c_a_qr) + '\n')
f102.write('-------------------------------------------------------------------------------------------\n')
f102.write('-------------------------------------------------------------------------------------------\n')
